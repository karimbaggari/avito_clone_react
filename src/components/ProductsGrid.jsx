            ...
            <div className=" py-6 lg:px-20 md:px-6 px-4">
                <form>
                    ...
                    <div className="relative" style={{ display: "flex", justifyContent: "flex-end" }}>
                        ...
                        <input type="search" onChange={event => setTimeout(() => setTitle(event.target.value), 500)} id="default-search" placeholder="Que recherchez-vous?" className="block p-4 bg-white pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" style={{ width: "39" + "em",background:"#fff",color:"#000" }} required="" />
